...
<title>Modify Beneficiary Page</title>
</head>
<body >
	<h1 id="welcomeText" align="center">Beneficiary List details to modify</h1>
	<br/>
	<br/>
	<div align="center" style="color: #0d5044; ">
	<h3>Select the beneficiary to modify by clicking on Edit button</h3>
	</div>
	<table id="customerInfo" style="background: cornsilk;">
			...
			<tbody>
				<c:forEach items="${beneficiaryList}" var="beneficiary">
					<tr>
						<td>
							<a href="../user/processModifyBenf/${beneficiary.beneficiaryID}"><input type="button" value="Edit" id="btnAppr"/></a>
						</td>
