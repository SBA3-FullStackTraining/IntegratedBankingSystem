...
<spring:form action="${pageContext.request.contextPath}/admin/adminLoanupdateconfirm" modelAttribute="LoanOutputDTO">
		...
		<center>
			<table id="table">
				...
				<tr>
					<th><spring:label path = "status">Approve/Decline Loan</spring:label></th>
					<td>Approved <spring:radiobutton path = "status" value="Approved" /></td>
					<td>Declined <spring:radiobutton path = "status" value="Declined" /></td>
				</tr>
                <tr>
					<th><spring:label path = "loanInterestRate">Interest Rate</spring:label></th>
					<td><spring:input path = "loanInterestRate" type ="text" /></td>
				</tr>
				<tr>
             ...
             <input name="Submit" type="submit" value="Update Loan" />
</spring:form>
