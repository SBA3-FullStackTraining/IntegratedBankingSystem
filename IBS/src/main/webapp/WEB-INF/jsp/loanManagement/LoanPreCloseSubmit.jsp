...
<h1 style="text-align:center">Loan Pre Close Request Form</H1>
<spring:form action="${pageContext.request.contextPath}/user/LoanPreClosesummary" modelAttribute="LoanOutputDTO">
		...
		<center>
			<table id="table">
				...
				<tr>
					<th><spring:label path = "emi">Loan EMI</spring:label></th>
					<td><spring:input path = "emi" type ="text" value="${LoanOutputDTO.emi}" readonly="true" /></td>
				</tr>
				<tr>
					<th><spring:label path = "loanInterestRate">Loan Interest Rate</spring:label></th>
					<td><spring:input path = "loanInterestRate" type ="text" value="${LoanOutputDTO.loanInterestRate}" readonly="true" /></td>
				</tr>
				<tr>
					<th><spring:label path = "status">Click here to Pre Close Loan</spring:label></th>
					<td><spring:radiobutton path = "status" value="loanPCR" /></td>
				</tr>
             ...
             <input name="Submit" type="submit" value="Submit Pre-Close Request" />
</spring:form>
