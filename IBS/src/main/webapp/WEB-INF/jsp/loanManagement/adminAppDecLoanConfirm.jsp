...
<h1 style="text-align:center">Loan Updated Successfully</H1>
...
<h3>Loan Interest Rate :${LoanOutputDTO.loanInterestRate}</h3>
<h3>Loan Monthly EMI   :${LoanOutputDTO.emi}</h3>
