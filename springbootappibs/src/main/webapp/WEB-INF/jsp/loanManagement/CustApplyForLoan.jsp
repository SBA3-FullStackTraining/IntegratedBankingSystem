...
<spring:form action="CustApplyForLoan" method="post">
...
<div>
				...
				<div>
					...
					<input type="radio" id="Individual" name="BusinessStruture" path="BusinessStruture"
						value="Individual" required> <label for="Individual">Individual</label>
					<input type="radio" id="Organisation" name="BusinessStruture" path="BusinessStruture"
						value="Organization" required> <label for="Organisation">Organization</label>
...
<spring:select path=loanTenure name=loanTenure id=loanTenure>
