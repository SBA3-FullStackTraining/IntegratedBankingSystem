...
<jsp:include page="header.jsp"/>
	...
	<div id="Customer" class="tabcontent">
		<spring:form class="custLoginform" method="post" action="user">
		<table>
			<tbody>
				<tr>
		...
		<input type="button" value="Register" id="register" onclick="location.href='static/html/customerRegister.html';" style="margin-left: 70px;"/>
		<br/><br/>
